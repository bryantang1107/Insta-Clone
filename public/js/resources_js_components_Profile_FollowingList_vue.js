...
/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = ({
  ...
  computed: {
    followingInt: function followingInt() {
  ...
  methods: {
    handleLoadMore: function handleLoadMore($state) {
      ...
      return _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee() {
        var _response$data, response, loader;
          ...
          while (1) {
            switch (_context.prev = _context.next) {
              case 0:
                ...
                _context.next = 4;
                return axios.get("/profile/".concat(_this.user_id, "/following?page=") + _this.page);

              case 4:
                response = _context.sent;

                if (((_response$data = response.data) === null || _response$data === void 0 ? void 0 : _response$data.length) > 0) {
                  _this.following_list = [].concat(_toConsumableArray(_this.following_list), _toConsumableArray(response.data));
                  _this.filtered_following_list = [].concat(_toConsumableArray(_this.following_list), _toConsumableArray(response.data));
                } else {
                  loader = document.querySelector(".infinite-loading-container");
          ...
          while (1) {
            switch (_context2.prev = _context2.next) {
              case 0:
                ...
                _this2.filtered_following_list = [];
                _this2.page = 1;
                _context2.next = 6;
                return axios.get("/profile/".concat(_this2.user_id, "/following"));

              case 6:
                response = _context2.sent;
                _this2.isLoading = false;
                _this2.following_list = response.data;
                _this2.filtered_following_list = response.data;
                _context2.next = 17;
                break;
        ...
        return _regeneratorRuntime().wrap(function _callee3$(_context3) {
          while (1) {
            switch (_context3.prev = _context3.next) {
              ...
              case 3:
                _this3.$toast.open({
                  message: "You have unfollowed ".concat(_this3.user.user.username, "!"),
                  type: "error",
                  position: "bottom",
                  queue: true
                });

                _this3.$store.dispatch("unfollowUser");
...
var render = function render() {
  ...
  }), _vm._v(" "), _vm.isLoading ? [_c("cube-spin")] : _vm.filtered_following_list.length < 1 && !_vm.isLoading ? [_c("p", {
    staticClass: "m-5 text-muted text-center"
  }, [_vm._v("No username found.")])] : [_vm._l(_vm.filtered_following_list, function (user, index) {
    return _c("div", {
      key: index
    }, [_c("User", {
      attrs: {
...
var render = function render() {
  ...
  return _c("div", {
    ...
    attrs: {
      "data-bs-toggle": "modal",
      "data-bs-target": _vm.follower ? "#unfollowUserFromFollowerList" : "#unfollowUserFromFollowingList"
    },
    on: {
      click: function click($event) {
